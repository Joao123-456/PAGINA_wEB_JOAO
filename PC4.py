...
if pagina_seleccionada == 'Inicio':
    ...
    st.markdown("<h1 style='text-align: center;'>¡Bienvenidos a Joaolandia 🪐!</h1>", unsafe_allow_html=True)
    ...
    col1.image("JOAO_1.jpg", caption='Joao Alvarez: publicista en proceso', width=300)
    ...
    texto = """
    ¡Hola! Mi nombre es Joao Alvarez y soy un estudiante de quinto ciclo de la carrera de Publicidad en la PUCP. 
    Tengo 19 años y soy de Lima. 
    Nací un 22 de marzo de 2006. 
    Entre mis hobbies está hacer deporte y salir a caminar. 
    Asimismo, suelo innovar en la cocina, preparando platillos que nunca me he atrevido a probar. 
    """

    # Las comillas triples (""") en Python se utilizan para definir cadenas multilínea.
    
    # Mostramos el texto
    col2.markdown(f"<div style='text-align: justify; font-size: 15px;'>{texto}<>", unsafe_allow_html=True)
    ...
    texto_2 = """
    Sin duda, el curso Pensamiento Computacional para Comunicaciones 
    me ha permitido explorar campos de estudio que nunca antes había explorado. 
    Me ha parecido interesante la dinámica del curso; nunca imaginé que podría llegar a crear proyectos como los que he creado. 
    ...
    st.markdown("<h2 style='text-align: center;'>Un poco de mi proceso de aprendizaje en phyton</h2>", unsafe_allow_html=True)
    ...
    #t.video("https://www.youtube.com/watch?v=X_Z7d04x9-E")
    ...
    st.markdown(f"<div style='text-align: center;'><a href='https://onedrive.live.com/?qt=allmyphotos&photosData=%2Fshare%2F7FA7AA122B21A36B%21s910acde5a79242aeb57258062b8f69b7%3Fithint%3Dvideo%26e%3DVPMXwZ%26migratedtospo%3Dtrue&sw=bypassConfig&cid=7FA7AA122B21A36B&id=7FA7AA122B21A36B%21s910acde5a79242aeb57258062b8f69b7&redeem=aHR0cHM6Ly8xZHJ2Lm1zL3YvYy83RkE3QUExMjJCMjFBMzZCL0VlWE5DcEdTcDY1Q3RYSllCaXVQYWJjQmxobU8tUXY3NXZ5V0VhQTZiQVlNS3c%5FZT1WUE1Yd1o&v=photos' target='_blank'><button>Ver video</button></a></div>", unsafe_allow_html=True) 
    ...
    st.markdown("<h1 style='text-align: center;'>Grafiquitos del ciclo</h1>", unsafe_allow_html=True)

    # Creamos una lista de gráficos
    graficos = ['Frecuencia de hashtags en campañas de vacunación en TikTok', 'Gráfico de cantidad de películas y series estrenadas por año', 'Mapita de ubicación de películas']
    ...
    if grafico_seleccionado == 'Frecuencia de hashtags en campañas de vacunación en TikTok':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Las campañas de salud en TikTok se enfocan en reforzar la confianza en las vacunas (#VacunasSeguras, #VacunaEsSeguridad) y en combatir la desinformación. Este uso de hashtags revela una estrategia emocional y educativa, adaptada al lenguaje digital de las redes sociales.</div>", unsafe_allow_html=True)
        st.image("Gráfico1.png", caption='Gráfico de lenguas aisladas', width=500)
        pass
    elif grafico_seleccionado == 'Gráfico de cantidad de películas y series estrenadas por año':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>El crecimiento exponencial en el número de películas y series desde los años 2000 refleja una explosión de contenido, probablemente impulsada por plataformas de streaming. Esto crea un entorno competitivo donde la originalidad y la diversidad cultural se vuelven clave para destacar.</div>", unsafe_allow_html=True)
        st.image("Gráfico2.png", caption='Gráfico de familias lingüísticas', width=500)
        pass
    elif grafico_seleccionado == 'Mapita de ubicación de películas':
        st.markdown("<div style='text-align: justify; font-size: 20px;'>Las locaciones de películas como Psicópata Americano (EE. UU.), Matrix (Australia), Parásitos (Corea del Sur), El Padrino (EE. UU.) y Toy Story 2 (EE. UU., animada) muestran cómo el cine global combina contextos locales con narrativas universales. Cada historia refleja su cultura de origen, pero logra conectar con audiencias globales.</div>", unsafe_allow_html=True)
        # Si "mapa_cusco.html" es un archivo HTML (no una imagen), debes mostrarlo con st.components.v1.html
        import streamlit.components.v1 as components
        with open("Mapa_final_pc4.html", "r", encoding="utf-8") as f:
            html_content = f.read()
